        ...
        const eventos = [
            ...
            // Agosto (Mês 7)   
            {dia: 16,mes: 7,ano: 2026,nome: "ON: Ocultação", link:"observacoes/on.html?obs=Giuliano Margoti&proj=Observações de ocultações no Observatório Nacional&PI=Giuliano Margoti&links=Kodai:https://gaiamoons.imcce.fr/occ.php?p=96134&det=qhy", classe: "event-on"},
            ...
            // Setembro (Mês 8)    
            {dia: 25,mes: 8,ano: 2026,nome: "ON: Ocultação", link:"observacoes/on.html?obs=Giuliano Margoti&proj=Observações de ocultações no Observatório Nacional&PI=Giuliano Margoti&links=Kodai:https://gaiamoons.imcce.fr/occ.php?p=96134&det=qhy", classe: "event-on"},
            // Outubro (Mês 9)
            // Novembro (Mês 10)
            {dia: 28,mes: 10,ano: 2026,nome: "ON: Ocultação", link:"observacoes/on.html?obs=Giuliano Margoti&proj=Observações de ocultações no Observatório Nacional&PI=Giuliano Margoti&links=Kodai:https://gaiamoons.imcce.fr/occ.php?p=96134&det=qhy", classe: "event-on"},
            // Dezembro (Mês 11)
            // Janeiro (Mês 0)
            // Fevereiro (Mês 1)
            // Março (Mês 2)
            {dia: 27,mes: 3,ano: 2027,nome: "ON: Ocultação", link:"observacoes/on.html?obs=Giuliano Margoti&proj=Observações de ocultações no Observatório Nacional&PI=Giuliano Margoti&links=Kodai:https://gaiamoons.imcce.fr/occ.php?p=96134&det=qhy", classe: "event-on"},
            // Abril (Mês 3)
            // Maio (Mês 4)
            // Junho (Mês 5)
            // Julho (Mês 6)
